...
Each build statically links zlib and libdeflate and rejects unexpected runtime dependencies.
...
HTSlib network access and bz2/lzma CRAM support. Downloads are handled by
...
include bcftools, HTSlib, zlib and libdeflate notices.
